...
def analyze_sales_data(filename):
    ...
    most_common_product = Counter(all_products).most_common(1)
    ...
    print(f"Mest sålda produkt: {most_common_product}, Antal: {most_common_product(1)}")  #FIXME: Redovisa mest sålda produkt här
